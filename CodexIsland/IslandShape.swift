...
struct IslandShellStyle: Equatable {
    ...
    static func forState(_ state: IslandPresentationState, approvalPanelShowsDenyReason: Bool = false) -> IslandShellStyle {
        ...
        case .collapsed(.detailed):
            IslandShellStyle(
                size: CGSize(width: 240, height: 33),
                topRadius: 6,
                bottomRadius: 12,
        ...
        case .collapsed(.simplified):
            IslandShellStyle(
                size: CGSize(width: 208, height: 33),
                topRadius: 14,
                bottomRadius: 20,
                backgroundOpacity: 1.0,
                strokeOpacity: 0.72,
        ...
        case .expanded(.approval(_)):
            IslandShellStyle(
                size: CGSize(width: 520, height: approvalPanelShowsDenyReason ? 370 : 270),
                topRadius: 8,
                bottomRadius: 20,
                backgroundOpacity: 1.0,
                strokeOpacity: 0.14,
